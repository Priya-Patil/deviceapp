...
public class RActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestPermission();
        prefManager=new PrefManager(RActivity.this);
        ...
        mHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                if(msg.what == MESSAGE_READ){
                  ...
                  //  prefManager.setTYPE(readMessage);
                ...
                if(msg.what == CONNECTING_STATUS){
                    if(msg.arg1 == 1) {
                       ...
                       /* Bundle bundle = new Bundle();
                        bundle.putString("EXTRA_DEVICE",(String) (msg.obj));
                        Utility.launchActivity(RActivity.this, BluetoothActivity.class, false, bundle);*/
                    }
                    else
        ...
        ha.postDelayed(new Runnable() {
            ...
            public void run() {
                //call function
              //  Toast.makeText(getBaseContext(), "555555555", Toast.LENGTH_SHORT).show();
    ...
    public void history( View v) {
        ...
        Intent intent = new Intent(RActivity.this,Main2Activity.class);
        startActivity(intent);
    }
    ...
    public void onBackPressed() {
        Utility.launchActivity(RActivity.this, AdminHomeActivity.class,false);
    }
}
